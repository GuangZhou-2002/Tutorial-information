    ...
    jQuery.fn = jQuery.prototype = {
        ...
        init: function(selector) {
            ...
            /* (1) 参数是函数 */
                ...
                /* 监听页面DOM的加载，等DOM加载完执行函数 */
                // if (DOM加载完了: loaded DOMContentLoaded) selector();
                // btn.onclick
            ...
            else if (isArray(selector) || (typeof selector == "object" && "length" in selector && selector.length - 1 in selector)) {
