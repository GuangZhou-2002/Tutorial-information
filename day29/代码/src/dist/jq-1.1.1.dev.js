...
(function () {
  ...
  var Tool = {
    ...
    isLikeArr: function isLikeArr(likeArr) {
      return this.isObject(likeArr) && "length" in likeArr && likeArr.length - 1 in likeArr;
    },
    ...
    init: function init(selector) {
      ...
      /* (1) 参数是函数 */
        ...
        /* (2) 参数是字符串 */
          ...
          else if (Tool.isArray(selector) || Tool.isLikeArr(selector)) {
  ...
  window.$ = window.jQuery = jQuery; // window.Tool = Tool;
})();